...
//    ViewController *viewController = [[ViewController init]alloc];
    return YES;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Terry-Chia.BallGame" in the application's documents directory.
